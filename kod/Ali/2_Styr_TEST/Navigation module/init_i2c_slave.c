...
void init_Styr_Slave() {
	/* Sets TWI enable to activate the I2C unit, sets TWI Enable Acknowledge Bit to allow ACK to be sent during transmissions.
   TWINT is cleared to initiate the I2C operation, enables TWI interrupt enable, enabling ISR (Interrupt Service Routine)
   to be executed on TWI events.
*/

	TWCR = (1 << TWEN) | (1 << TWEA) | (1 << TWINT) | (1 << TWIE);
	// Set the own I2C address
